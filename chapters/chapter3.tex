...
An alternative approach to proving Theorem \ref{thm:adjoint_method}, proposed by my thesis supervisor, Professor Mengwu Guo, yields the following proof. We include it here as it offers additional insight into the problem.
